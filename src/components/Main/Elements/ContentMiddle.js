      ...
      <div className="middle">
        <form className="middle__form" action="./product">
          <button className="middle__btn">
            Browse All Product <i className="fa-solid fa-right-long"></i>
          </button>
        </form>
        <section className="middle__offer">
          <div className="middle__img">
            <div className="middle__sale">
              <h2 className="middle__sale-h2">
                30% <span className="middle__sale-h2_clr">OFFER</span>
              </h2>
          ...
          <div className="middle__box">
            <div className="middle__discription">
              ...
              <div className="middle__text">
                <div className="middle__text-h2">Free Delivery</div>
            ...
            <div className="middle__discription">
              ...
              <div className="middle__text">
                <div className="middle__text-h2">Sales &#38 discounts</div>
                <p className="middle__text-p">
                  Worldwide delivery on all. Authorit tively morph next-generation innov tion with extensive models.
                </p>
              </div>
            ...
            <div className="middle__discription">
              ...
              <div className="middle__text">
                <div className="middle__text-h2">Quality assurance</div>
                <p className="middle__text-p">
                  Worldwide delivery on all. Authorit tively morph next-generation innov tion with extensive models.
                </p>
              </div>
