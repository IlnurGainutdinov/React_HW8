...
const Basket = () => {
  ...
  useEffect(() => {
    setSub(products.reduce((sum, product) => sum + product.quantity * product.price, 0));

    setTotal(products.reduce((sum, product) => sum + (product.quantity * product.price + product.shipping), 0));
  }, [products]);
        ...
        <section className="filling-form">
          <form className="filling-form__adress">
            ...
            <details className="filling-form__sum">
              <summary className="filling-form__summary">
                Bangladesh
                <svg
          ...
          <div className="filling-form__total">
            <p className="filling-form__text-p1">
              Sub total {"\u00A0"} <span className="sub-total"> ${sub}</span>
            </p>
            <h2 className="filling-form__text-h3">
              GRAND TOTAL {"\u00A0"} <span className="filling-form__span"> ${total}</span>
            </h2>
