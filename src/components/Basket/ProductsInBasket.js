    ...
    <div className="shopping__product">
      <div className="shopping__card">
        ...
        <div className="card__details">
          ...
          <h3 className="card__parametr">
            Color: <span className="card__span">{color}</span>
          </h3>
          <h3 className="card__parametr">
            Size: <span className="card__span">{sizes}</span>
          </h3>
        </div>
      </div>
      ...
      <div className="shopping__card-tbl subtotal">
        <h3 className="card__parametr ">
          $ <span className="subtotal">{price * quantity + shipping}</span>
        </h3>
      </div>
      <div className="shopping__card-tbl ">
        <a id={id} className="delete_btn" href="#" onClick={handleDelete}>
          <img src="./img/shopping/shop_close.jpg" alt="close button" />
        </a>
      </div>
    </div>
  );
