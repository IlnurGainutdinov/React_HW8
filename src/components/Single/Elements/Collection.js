  ...
  return (
    <section className="container-low">
      <section className="collection">
        ...
        <p className="collection__text-p">
        ...
        <div className="collection__info">
          <h3 className="collection__text-h3">
            MATERIAL: <span className="collection__text">COTTON</span>
          </h3>
          <h3 className="collection__text-h3">
            DESIGNER: <span className="collection__text">BINBURHAN </span>
          </h3>
        </div>
              ...
              <div className="collection-box__sort-by">
                <details className="collection-box__sort-det">
                  <summary className="collection-box__sort-det__summary">
                    ...
                    <svg
                      className="angle-down arrow_margin"
