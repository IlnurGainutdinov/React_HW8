...
const Products = () => {
  ...
  const filteredProducts = dataSecond.filter(
    (product) => selectedSizes.length === 0 || product.sizes.some((size) => selectedSizes.includes(size))
  );
        ...
        <section className="product-box">
          <div className="product-box__menu">
            <div className="product-box__content">
              <details open className="product-box__item">
                <summary className="product-box__head">
                  CATEGORY
                  <svg
                ...
                <div className="product-box__link-box">
                  <a href="#" className="product-box__link">
                    {" "}
                    Accessories
                  </a>
                  <a href="#" className="product-box__link">
          ...
          <div className="product-box__cards-box">
            ...
            <div className="product-box__sorting">
              <div className="product-box__sort-by">
                ...
                <details className="product-box__sort-det">
                  <summary className="product-box__sort-det__summary">
                    Name
                    <svg
                      className="angle-down"
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="product-box__bottom">
              ...
              <form action="#">
                <button className="product-box__navigation-btn">View All</button>
              </form>
            </div>
          </div>
        </section>
