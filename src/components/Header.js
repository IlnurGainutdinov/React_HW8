...
const Header = () => {
  ...
  useEffect(() => {
    setSub(products.reduce((sum, product) => sum + product.price, 0));
  }, [products]);
          ...
          <div className="header__search">
            <div className="mini__menu">
              <details className="mini__search">
                <summary className="mini__search__btn">
                  Browse
                  <svg
        ...
        <div className="header__basketbutton">
          <div className="header__basket">
            ...
            <div className="basketbutton-box">
              ...
              <a className="box__link-btn" href="./checkout">
                Checkout
              </a>
              <a className="box__link-btn box__link-btn_clr" href="./basket">
                Go to cart
              </a>
            </div>
          </div>
          ...
          <form action="">
            <button className="header__basketbutton__btn">
              My Account
              <svg
                className="header__basketbutton_svg"
                fill="#fff"
                height="9px"
                width="9px"
                version="1.1"
      ...
      <section className="menu">
        <ul className="menu__box" action="">
          <li className="menu__list">
            <a className="menu__box__btn" href="#">
              Home
            </a>
          </li>
          <li className="menu__list">
